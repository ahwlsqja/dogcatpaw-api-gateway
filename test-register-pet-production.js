...
async function registerPetProduction() {
  try {
    ...
    const noseImagePath = process.argv[2] || './test-nose-image26.jpg';
    ...
    formData.append('specifics', PET_DATA.specifics);
    ...
    formData.append('neutral', PET_DATA.neutral.toString());
    formData.append("images", PET_DATA.images)
    ...
    registerFormData.append('neutral', PET_DATA.neutral.toString());
    registerFormData.append('images', PET_DATA.images);
